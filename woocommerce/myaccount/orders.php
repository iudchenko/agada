...
<?php if ( $has_orders ) : ?>
	...
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
				...
				<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
					<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
						<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
							...
							<?php elseif ( 'order-item' === $column_id ) : ?>
								<?php 
								// Get and Loop Over Order Items
								foreach ( $order->get_items() as $item_id => $item ) {
									$product_name = $item->get_name();
									echo '<a href="'. $order->get_view_order_url() .'">'.esc_attr($product_name) . '</a><br>';
								}
									?>
		...
		<tfoot>
			<tr class="custom-order-total-row">
				<td  class="custom-order-total-row__text"><?php _e('The total amount of purchases', 'agada');?>

				</td>
				<td class="custom-order-total-row__total">
				<?php 
