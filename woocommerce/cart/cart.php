				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<div class="product-sku">
							<?php if(esc_attr( $_product->get_sku() )) echo esc_attr( $_product->get_sku() ); ?>
						</div>

						<div class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
							<span><?php _e('Qty:', 'agada');?></span>
...
<div class="cart-info-wrapper">
	...
	<div class="custom-cart-shipping-info">
			<h3>Shipping Info</h3>
			<p>Estimated ship date if ordered by 2 PM PT Monday: Thursday, July 21st, depending on ring size.</p>
			...
			<p><a>Chat now</a> or call <a>800.691.0952</a></p>
	</div>
